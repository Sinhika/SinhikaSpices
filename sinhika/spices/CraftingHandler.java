...
/**
 * special-case crafting hook. In this case, we use it to implement tools that are used
 * in recipes, but not consumed.
 * @author Sinhika
 *
 */
public class CraftingHandler implements ICraftingHandler {
	...
	/**
     * Hook for what happens when crafting done. This handler deals with the case of 
     * crafting with a tool (bark spud) that is not consumed when used in a recipe.
     *
			...
			IInventory craftMatrix)
	{
		...
		for (int i=0; i < craftMatrix.getSizeInventory(); i++) {
			...
			Spices.log.warning("CraftingHandler::onCrafting: Something went horribly wrong!");
